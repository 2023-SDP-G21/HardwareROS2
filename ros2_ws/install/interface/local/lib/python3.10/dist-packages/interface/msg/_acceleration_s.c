...
bool interface__msg__acceleration__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.msg._acceleration.Acceleration", full_classname_dest, 40) == 0);
  }
  interface__msg__Acceleration * ros_message = _ros_message;
  {  // acceleration_x
...
PyObject * interface__msg__acceleration__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface.msg._acceleration");

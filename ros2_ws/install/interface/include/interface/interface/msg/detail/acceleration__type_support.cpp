...
{
  new (message_memory) interface::msg::Acceleration(_init);
}

void Acceleration_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::msg::Acceleration *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Acceleration_message_member_array[3] = {
  {
    ...
    offsetof(interface::msg::Acceleration, acceleration_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::msg::Acceleration, acceleration_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::msg::Acceleration, acceleration_z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Acceleration_message_members = {
  ...
  3,  // number of fields
  sizeof(interface::msg::Acceleration),
...
get_message_type_support_handle<interface::msg::Acceleration>()
{
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Acceleration_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, Acceleration)() {
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Acceleration_message_type_support_handle;
}

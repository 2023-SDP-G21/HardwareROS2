...
{
  new (message_memory) message::msg::Motor(_init);
}

void Motor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message::msg::Motor *>(message_memory);
  typed_message->~Motor();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motor_message_member_array[2] = {
  {
    ...
    offsetof(message::msg::Motor, motor_left_power),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message::msg::Motor, motor_right_power),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<message::msg::Motor>()
{
  return &::message::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message, msg, Motor)() {
  return &::message::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}

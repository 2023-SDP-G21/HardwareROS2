...
#     motor_left = Motor(enable1=21, pwm1=16, pwm2=20)
#     motor_right = Motor(enable1=26, pwm1=13, pwm2=19)
...
class MinimalPublisher(Node):
    ...
    def callback(self, msg):
        self.get_logger().info(f'I heard motor value: "{msg.motor_left_power, msg.motor_right_power}"')
